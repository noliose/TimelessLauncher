...
```json
{
    ...
    "discord": {
        ...
        "smallImageText": "Timeless Server",
        "smallImageKey": "seal-circle"
    },
    "rss": "https://timelessserver.com/articles/index.rss",
    "servers": [
        {
            "id": "Example_Server",
            "name": "Timeless Server Example Client",
            "description": "Example Timeless Server server. Connect for fun!",
            "icon": "http://mc.timelessserver.com/TimelessServer/files/example_icon.png",
            "version": "0.0.1",
            "address": "mc.timelessserver.com:1337",
            "minecraftVersion": "1.11.2",
            "discord": {
                "shortId": "Example",
                "largeImageText": "Timeless Server Example Server",
    ...
    "subModules": [
        {
            ...
            "artifact": {
                ...
                "url": "http://mc.timelessserver.com/TimelessServer/files/1.11.2/launchwrapper-1.12.jar"
            }
        }
    ]
}
...
```json
{
    ...
    "artifact": {
        ...
        "url": "http://mc.timelessserver.com/TimelessServer/files/1.11.2/liteloader-1.11.2.jar"
    },
    "subModules": [
...
```json
{
    ...
    "artifact": {
        ...
        "url": "http://mc.timelessserver.com/TimelessServer/files/1.11.2/jopt-simple-4.6.jar"
    }
}
```
...
```json
{
    "id": "com.timelessserver:timelessblocks:3.0.0-beta-6-133",
    "name": "TimelessBlocks (3.0.0-beta-6-133)",
    "type": "ForgeMod",
    "artifact": {
        "size": 16321712,
        "MD5": "5a89e2ab18916c18965fc93a0766cc6e",
        "url": "http://mc.timelessserver.com/TimelessServer/prod-1.11.2/mods/TimelessBlocks.jar"
    }
}
```
...
```json
{
    ...
    "artifact": {
        ...
        "url": "http://mc.timelessserver.com/TimelessServer/prod-1.11.2/mods/macrokeybindmod.litemod"
    }
}
```
...
```json
{
    "id": "com.timelessserver:timelessserverrp:2017-08-16",
    "name": "Timeless Server Resource Pack (2017-08-16)",
    "type": "file",
     "artifact": {
        "size": 45241339,
        "MD5": "ec2d9fdb14d5c2eafe5975a240202f1a",
        "path": "resourcepacks/TimelessServer.zip",
        "url": "http://mc.timelessserver.com/TimelessServer/prod-1.11.2/resourcepacks/TimelessServer.zip"
    }
}
```
